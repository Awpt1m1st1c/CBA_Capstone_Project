...
const LocationTrends = ({ locations }) => {
  ...
  console.log("LocationTrends received locations:", locations);
  ...
  // Show locations even if they have null values - they still represent valid locations
                ...
                >
                  ...
                  <div className="grid grid-cols-2 gap-3 text-sm">
                    <div>
                      <span className="text-gray-500 block mb-1">Price per sq.ft</span>
                      <span className="font-medium">
                        {location.price_per_sqft && location.price_per_sqft > 0 ? `₹${location.price_per_sqft.toLocaleString()}` : 'N/A'}
                      </span>
                    </div>
                    <div>
                      <span className="text-gray-500 block mb-1">Annual Increase</span>
                      <div className="flex items-center">
                        {location.percent_increase != null && location.percent_increase > 0 ? (
                          <>
                            <span className="font-medium">{location.percent_increase}%</span>
                            {location.percent_increase >= 10 && (
                              <span className="ml-1.5 p-1 bg-green-100 rounded-full">
                    ...
                    <div>
                      <span className="text-gray-500 block mb-1">Rental Yield</span>
                      <div className="font-medium">
                        {location.rental_yield != null && location.rental_yield > 0 ? `${location.rental_yield}%` : 'N/A'}
                      </div>
                    </div>
                    <div>
                      {location.rental_yield != null && (
                ...
                <tbody className="divide-y divide-gray-200">
                  {processedLocations.map((location, index) => (
                    ...
                    >
                      ...
                      <td className="py-3 px-4">
                        <div className="flex items-center">
                          {location.rental_yield != null && location.rental_yield > 0 ? (
                            <>
                              {location.rental_yield}%
                              <div className="ml-2 w-16 h-2 bg-gray-200 rounded-full overflow-hidden">
                                <div 
